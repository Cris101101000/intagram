...
const SOLUTION_LINKS = [
  { label: 'Capta', url: 'https://www.bewe.io/soluciones/capta' },
  { label: 'Gestiona', url: 'https://www.bewe.io/soluciones/gestiona' },
  { label: 'Fideliza', url: 'https://www.bewe.io/soluciones/fideliza' },
  { label: 'Linda AI', url: 'https://www.bewe.io/negocios/linda-para-clientes' },
];
...
export function BeweFooter() {
  return (
    <footer style={{ background: '#0A2540', padding: '60px 24px 32px' }}>
      ...
      >
        {/* Left column */}
        <div className="flex flex-col items-start" style={{ maxWidth: 480 }}>
          <Image
            src="/bewe-logo.png"
          ...
          <p className="font-inter" style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>
            &copy; 2026 Bewe &middot;{' '}
            <a
              href="https://www.bewe.io/politica-de-privacidad"
              target="_blank"
              rel="noopener noreferrer"
