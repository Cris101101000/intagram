...
const FLOATING_EMOJIS: { emoji: string; top?: string; left?: string; right?: string; bottom?: string; size: number; delay: string; duration: string }[] = [
...
export function TrialCTA({ level }: TrialCTAProps) {
  const cfg = LEVEL_CONFIG[level];

  return (
    <div className="reveal">
      <div
        className="relative z-10 mx-auto flex flex-col items-center text-center overflow-hidden rounded-3xl border border-gray-200 bg-white"
        style={{
          maxWidth: 680,
          padding: '64px 40px',
