...
export const LEVEL_CONFIG: Record<ScoreLevel, LevelConfig> = {
  ...
  [ScoreLevel.EXCELENTE]: {
    ...
    rankingConsequence: 'de negocios de {{sector}} en Latinoamérica tienen un rendimiento inferior al tuyo. Estás construyendo una presencia digital que la mayoría de tu competencia no tiene. El reto ahora es mantener ese liderazgo y diversificar tus canales de captación.',
    rankingConsequenceShort: 'de negocios de {{sector}} tienen un rendimiento inferior al tuyo. El reto ahora es mantener tu liderazgo y seguir escalando.',
